...
| 09.05.2026 | 1    | Fixed owner and admin can delete owners account, but admin can't delete it's admins account, add backend request.body shows only in dev-mode |
| Total      | 379  |
