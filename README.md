...
| 09.05.2026 | 3    | Fixed owner and admin can delete owners account, but admin can't delete it's admins account, add backend request.body shows only in dev-mode, fix playwright workflow. Added webServer for playwright so backend starts automatically befere tests. Added env's to playwright.yml |
| Total      | 380  |
